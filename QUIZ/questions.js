export default [
  {
    ...
    difficulty: "facil",
    answers: [
      { option: "A energia gerada pelos ventos.", correct: false },
      { option: "A energia proveniente da água.", correct: false },
      { option: "A energia gerada pela luz e calor do Sol.", correct: true },
      { option: "A energia criada a partir de minerais.", correct: false },
    ],
  },
  {
  ...
  {
    question: "Como os painéis solares geram eletricidade?",
    difficulty: "facil",
    answers: [
      { option: "Eles usam a luz solar para gerar eletricidade através do efeito fotovoltaico.", correct: true },
      { option: "Eles transformam o vento em energia elétrica.", correct: false },
      { option: "Eles armazenam energia térmica e liberam eletricidade.", correct: false },
      { option: "Eles convertem calor do solo em eletricidade.", correct: false },
    ],
  },
  {
  ...
  {
    question: "A energia solar pode ser utilizada durante a noite? Por quê?",
    difficulty: "facil",
    answers: [
      { option: "Não, porque não há luz solar à noite", correct: true },
      { option: "Sim, porque o sol brilha à noite", correct: false },
      { option: "Sim, porque os painéis funcionam sem luz", correct: false },
      { option: "Não, porque precisa de vento", correct: false },
    ],
  },
  {
  ...
  // Novas questões fáceis
  {
    question: "Qual destes equipamentos pode funcionar com energia solar?",
    difficulty: "facil",
    answers: [
      { option: "Calculadora", correct: true },
      { option: "Fogão a gás", correct: false },
      { option: "Torneira comum", correct: false },
      { option: "Chuveiro a lenha", correct: false },
    ],
  },
  {
  ...
  {
    question: "Qual destes é um tipo de energia limpa?",
    difficulty: "facil",
    answers: [
      { option: "Solar", correct: true },
      { option: "Carvão", correct: false },
      { option: "Petróleo", correct: false },
  ...
  {
    question: "Qual destes é um exemplo de fonte renovável?",
    difficulty: "facil",
    answers: [
      { option: "Energia solar", correct: true },
      { option: "Petróleo", correct: false },
      { option: "Carvão mineral", correct: false },
      { option: "Gás natural", correct: false },
    ],
  },
  {
